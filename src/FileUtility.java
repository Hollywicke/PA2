...
class FileUtility {
	...
	/*
	 * retrieve the next line of the input script file returns null if there are no
	 * additional lines
	 */
	String nextLine() {
		return nextLine(0);
	 ...
	 *
	 * Relative addresses are accepted ("out/f.txt"). If the file is not present,
	 ...
	 * Load some data
	 *
	 * Relative addresses are accepted ("out/f.txt"). If a file is not present,
